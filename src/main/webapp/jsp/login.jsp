...
<script src="js/jquery-easyui-1.2.6/jquery-1.72.min.js" type="text/javascript"></script>
...
<div class="login_div">
	...
	<form action="user/user_login.action" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="u_userName" id="name" value="" placeholder="&nbsp;&nbsp;用户名"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
			...
			<div class="nav login_psdNav">
				...
				<div class="col-xs-6">
					<input type="password" name="u_password" id="psd" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorBylogin(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
