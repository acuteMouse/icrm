    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#dg').datagrid({
                        ...
                        if (arr.length < 1) {
                            ...
                            $.messager.confirm('友情提示', '确定要删除吗？', function (r) {
                                if (!r) {
                                    ...
                                    $.ajax({
                                        url: 'user/userType_delete.action',
                                        data: {'ids': ids},//发送数据
                                        type: "post",
                                        success: function () {
                                            $('#dg').datagrid('reload');
                ...
                pagination: true,
                url: 'user/userType_getAll.action',
                idField: 'id',
                frozenColumns: [[{
                    field: 'checkbox',
                    width: 50,
                ...
                columns: [[
                    ...
                    {field: 'ut_name', title: '名称', width: 100},
            ...
            $('#btn1').click(
                    function () {
                        if ($('#myform').form('validate')) {
                            $.ajax({
                                type: 'post',
                                url: flag == 'add' ? 'user/userType_add.action' : 'user/userType_update.action',
