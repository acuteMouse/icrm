    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#dg').datagrid({
                        ...
                        if (arr.length < 1) {
                            ...
                            $.messager.confirm('友情提示', '确定要删除吗？', function (r) {
                                if (!r) {
                                    ...
                                    $.ajax({
                                        url: 'user/department_delete.action',
                                        data: {'ids': ids},//发送数据
                                        type: "post",
                                        success: function () {
                                            $('#dg').datagrid('reload');
                ...
                pagination: true,
                url: 'user/department_getAll.action',
                idField: 'id',
                frozenColumns: [[{
                    field: 'checkbox',
                    width: 50,
                ...
                columns: [[
                    ...
                    {field: 'd_name', title: '名称', width: 100},
                ]],
//                设置分页初始值，可选项
                pageNumber: 1,
                pageSize: 15,
            ...
            $('#btn1').click(
                    function () {
                        if ($('#myform').form('validate')) {
                            $.ajax({
                                type: 'post',
                                url: flag == 'add' ? 'user/department_add.action' : 'user/department_update.action',
...
<div id="dd" class="easyui-dialog" title="添加客户" modal=true
    ...
    <form id="myform" method="post" style="text-align: center;">
        ...
        名称:
        <input class="easyui-validatebox" type="text" name="d_name"
